...
static const char auth_key_test[] = "ZosyJN4LymO8CiyxrSqTxlDbXDF998Pq";
static const char device_id_test[] = "tuyaecb859e259a8";
static const uint8_t mac_test[6] = {0x59,0x5A,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D315A59
